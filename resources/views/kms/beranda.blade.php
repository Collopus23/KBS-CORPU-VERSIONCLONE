                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="post-content">
                                        ...
                                        <p>1. <a class="hover text-info" href="{{ url('/kms/ensiklopedia-kepegawaian-umum') }}">Ensiklopedia Kepegawaian Umum</a> berisikan pengetahuan dasar Ilmu Kepegawaian berdasarkan peraturan perundang-undangan dalam format Ensiklopedia bertaut layaknya Wikipedia.</p>
                                        <p>2. <a class="hover text-info" href="{{ url('/login-option') }}">Knowledge Instansi</a> berisikan pengetahuan spesifik untuk kebutuhan khusus BKPSDM instansi pemerintah mitra kerja KBS Corpu Provinsi Bali. Untuk mengakses fitur ini, Anda harus login menggunakan akun yang telah teregistrasi.</p>
                ...
                <aside class="col-lg-3 sidebar mt-8 mt-lg-6">
                    ...
                    <div class="widget">
                        <ul class="icon-list bullet-bg bullet-soft-green">
                            <li><span><i class="uil uil-arrow-right"></i></span><a class="hover text-success" href="{{ url('/kms') }}"> Mulai</a></li>
                            <li><span><i class="uil uil-arrow-right"></i></span><a class="hover text-dark" href="{{ url('/kms/ensiklopedia-kepegawaian-umum') }}"> Ensiklopedia Kepegawaian Umum</a></li>
