<nav class="navbar navbar-expand-lg center-nav transparent position-absolute navbar-dark">
    <div class="container flex-lg-row flex-nowrap align-items-center">
        ...
        <div class="navbar-collapse offcanvas offcanvas-nav offcanvas-start">
            ...
            <div class="offcanvas-body ms-lg-auto d-flex flex-column h-100">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(url('/')); ?>/#nav-beranda">Beranda</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(url('/')); ?>/#nav-tentang">Tentang</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(url('/')); ?>#nav-framework">Framework</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(url('/')); ?>#nav-visimisi">Visi dan Misi</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(url('/')); ?>#nav-logo">Tentang Logo</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo e(url('/')); ?>#nav-galeri">Galeri</a>
                    </li>
                    <?php
    ...
    <!-- /.container -->
</nav><?php /**PATH T:\Clone KBS CORPU\kbs-corpu\resources\views/landing/nav-verse-2.blade.php ENDPATH**/ ?>