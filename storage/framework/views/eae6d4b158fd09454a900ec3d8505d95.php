<?php $__env->startSection('landing/content'); ?>
    <section class="wrapper image-wrapper bg-image bg-overlay bg-overlay-300" data-image-src="<?php echo e(asset('assets/landing/img/photos/bg3-red.jpg')); ?>" id="nav-beranda">
                        ...
                        <div class="swiper rounded">
                            <div class="swiper-wrapper rounded">
                                <div class="swiper-slide rounded">
                                    <img src="<?php echo e(asset('assets/landing/img/slider/1.jpg')); ?>" class="rounded" alt="" />
                                ...
                                <div class="swiper-slide rounded">
                                    <img src="<?php echo e(asset('assets/landing/img/slider/2.jpg')); ?>" class="rounded" alt="" />
                                ...
                                <div class="swiper-slide rounded">
                                    <img src="<?php echo e(asset('assets/landing/img/slider/3.jpg')); ?>" class="rounded" alt="" />
                ...
                <div class="col-lg-6 order-lg-2">
                    <div class="row gx-md-5 gy-5" data-cues="fadeIn" data-group="images" data-disabled="true">
                        <div class="col-md-4 offset-md-2 align-self-end" data-cue="fadeIn" data-group="images">
                            <figure class="rounded"><img src="<?php echo e(asset('assets/landing/img/photos/g1.jpg')); ?>"
                                    srcset="<?php echo e(asset('assets/landing/img/photos/g1@2x.jpg')); ?> 2x" alt=""></figure>
                        </div>
                        <div class="col-md-6 align-self-end" data-cue="fadeIn" data-group="images">
                            <figure class="rounded"><img src="<?php echo e(asset('assets/landing/img/photos/g2.jpg')); ?>"
                                    srcset="<?php echo e(asset('assets/landing/img/photos/g2@2x.jpg')); ?> 2x" alt=""></figure>
                        </div>
                        <div class="col-md-6 offset-md-1" data-cue="fadeIn" data-group="images">
                            <figure class="rounded"><img src="<?php echo e(asset('assets/landing/img/photos/g3.jpg')); ?>"
                                    srcset="<?php echo e(asset('assets/landing/img/photos/g3@2x.jpg')); ?> 2x" alt=""></figure>
                        </div>
                        <div class="col-md-4 align-self-start" data-cue="fadeIn" data-group="images">
                            <figure class="rounded"><img src="<?php echo e(asset('assets/landing/img/photos/g4.jpg')); ?>"
                                    srcset="<?php echo e(asset('assets/landing/img/photos/g4@2x.jpg')); ?> 2x" alt=""></figure>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
    ...
    <section class="wrapper bg-gradient-reverse-primary">
        <div class="container py-8 py-md-8">
            <div class="row gx-lg-8 gx-xl-12 gy-10 mb-8 align-items-center">
                ...
                <!--/column -->
                <div class="col-lg-6">
                    <figure><img class="w-auto" src="<?php echo e(asset('assets/landing/img/illustrations/3d4.png')); ?>"
                            srcset="<?php echo e(asset('assets/landing/img/illustrations/3d4@2x.png')); ?> 2x" alt=""></figure>
                </div>
                <!--/column -->
            </div>
            <!--/.row -->
                        ...
                        <div class="card shadow-lg">
                            <div class="card-body">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 454.6"
                                    data-inject-url="<?php echo e(asset('assets/landing/img/icons/lineal/chat-2.svg')); ?>"
                                ...
                                <a href="<?php echo e(url('/kms')); ?>" class="more hover link-green">Selengkapnya</a>
                            </div>
                            <!--/.card-body -->
                        </div>
                        <!--/.card -->
                        ...
                        <div class="card shadow-lg">
                            <div class="card-body">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 409.6 362.5"
                                    data-inject-url="<?php echo e(asset('assets/landing/img/icons/lineal/megaphone.svg')); ?>"
                                ...
                                <a href="<?php echo e(url('/login-option')); ?>" class="more hover link-blue">Selengkapnya</a>
                            </div>
                            <!--/.card-body -->
                        </div>
                        <!--/.card -->
    ...
    <section class="wrapper bg-light" id="nav-visimisi">
        <div class="container py-16 py-md-18">
            <div class="row gx-lg-8 gx-xl-12 gy-10 mb-8 align-items-center">
                <div class="col-lg-6 order-lg-2">
                    <figure><img class="w-auto" src="<?php echo e(asset('assets/landing/img/illustrations/i22.jpg')); ?>"
                            srcset="<?php echo e(asset('assets/landing/img/illustrations/i22@2x.png')); ?> 2x" alt=""></figure>
                </div>
                <!--/column -->
                <div class="col-lg-6">
    ...
    <section class="wrapper bg-gradient-reverse-primary" id="nav-logo">
        <div class="container py-13 py-md-16">
            <div class="row gx-lg-8 gx-xl-12 gy-10 mb-8 align-items-center">
                ...
                <!--/column -->
                <div class="col-lg-6">
                    <figure><img class="w-auto mx-auto d-block" src="<?php echo e(asset('assets/landing/img/logo-big.png')); ?>"
                            srcset="<?php echo e(asset('assets/landing/img/logo-big.png')); ?> 2x" alt=""></figure>
                </div>
                <!--/column -->
            </div>
            <!--/.row -->
                ...
                <div class="swiper swiper-initialized swiper-horizontal swiper-pointer-events">
                    <div class="swiper-wrapper" id="swiper-wrapper-4e7374f38ce4e189" aria-live="off"
                        ...
                        <div class="swiper-slide swiper-slide-active" role="group" aria-label="1 / 6"
                            ...
                            <figure class="rounded mb-6"><img src="<?php echo e(asset('assets/landing/img/photos/pd7.jpg')); ?>"
                                    srcset="<?php echo e(asset('assets/landing/img/photos/pd7@2x.jpg')); ?> 2x" alt=""><a
                                    class="item-link swiper-no-swiping" href="<?php echo e(asset('assets/landing/img/photos/pd7-full.jpg')); ?>"
                        ...
                        <div class="swiper-slide swiper-slide-next" role="group" aria-label="2 / 6"
                            style="width: 410px; margin-right: 30px;">
                            <figure class="rounded mb-6"><img src="<?php echo e(asset('assets/landing/img/photos/pd8.jpg')); ?>"
                                    srcset="<?php echo e(asset('assets/landing/img/photos/pd8@2x.jpg')); ?> 2x" alt=""><a
                                    class="item-link swiper-no-swiping" href="<?php echo e(asset('assets/landing/img/photos/pd8-full.jpg')); ?>"
                                    data-glightbox="" data-gallery="projects-group"><i
                                        class="uil uil-focus-add"></i></a></figure>
                            <div class="project-details d-flex justify-content-center flex-column">
                                <div class="post-header">
                        ...
                        <div class="swiper-slide" style="width: 410px; margin-right: 30px;" role="group"
                            aria-label="3 / 6">
                            <figure class="rounded mb-6"><img src="<?php echo e(asset('assets/landing/img/photos/pd9.jpg')); ?>"
                                    srcset="<?php echo e(asset('assets/landing/img/photos/pd9@2x.jpg')); ?> 2x" alt=""><a
                                    class="item-link swiper-no-swiping" href="<?php echo e(asset('assets/landing/img/photos/pd9-full.jpg')); ?>"
                                    data-glightbox="" data-gallery="projects-group"><i
                                        class="uil uil-focus-add"></i></a></figure>
                            <div class="project-details d-flex justify-content-center flex-column">
                                <div class="post-header">
                        ...
                        <div class="swiper-slide" role="group" aria-label="4 / 6"
                            style="width: 410px; margin-right: 30px;">
                            <figure class="rounded mb-6"><img src="<?php echo e(asset('assets/landing/img/photos/pd10.jpg')); ?>"
                                    srcset="<?php echo e(asset('assets/landing/img/photos/pd10@2x.jpg')); ?> 2x" alt=""><a
                                    class="item-link swiper-no-swiping" href="<?php echo e(asset('assets/landing/img/photos/pd10-full.jpg')); ?>"
                                    data-glightbox="" data-gallery="projects-group"><i
                                        class="uil uil-focus-add"></i></a></figure>
                            <div class="project-details d-flex justify-content-center flex-column">
                                <div class="post-header">
                        ...
                        <div class="swiper-slide" role="group" aria-label="5 / 6"
                            style="width: 410px; margin-right: 30px;">
                            <figure class="rounded mb-6"><img src="<?php echo e(asset('assets/landing/img/photos/pd11.jpg')); ?>"
                                    srcset="<?php echo e(asset('assets/landing/img/photos/pd11@2x.jpg')); ?> 2x" alt=""><a
                                    class="item-link swiper-no-swiping" href="<?php echo e(asset('assets/landing/img/photos/pd11-full.jpg')); ?>"
                                    data-glightbox="" data-gallery="projects-group"><i
                                        class="uil uil-focus-add"></i></a></figure>
                            <div class="project-details d-flex justify-content-center flex-column">
                                <div class="post-header">
                        ...
                        <div class="swiper-slide" role="group" aria-label="6 / 6"
                            style="width: 410px; margin-right: 30px;">
                            <figure class="rounded mb-6"><img src="<?php echo e(asset('assets/landing/img/photos/pd12.jpg')); ?>"
                                    srcset="<?php echo e(asset('assets/landing/img/photos/pd12@2x.jpg')); ?> 2x" alt=""><a
                                    class="item-link swiper-no-swiping" href="<?php echo e(asset('assets/landing/img/photos/pd12-full.jpg')); ?>"
                                    data-glightbox="" data-gallery="projects-group"><i
                                        class="uil uil-focus-add"></i></a></figure>
                            <div class="project-details d-flex justify-content-center flex-column">
                                <div class="post-header">
...
<?php echo $__env->make('landing/master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH T:\Clone KBS CORPU\kbs-corpu\resources\views/landing/beranda.blade.php ENDPATH**/ ?>